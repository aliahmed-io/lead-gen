    ...
    if (data.businesses) {
      ...
      rawRecords = Object.entries(businesses).map(([key, b]) => {
        ...
        return {
          ...
          qualityTier: b.qualityTier || (b.qualityGrade ? ({ A: 'top', B: 'top', C: 'average', D: 'low', F: 'low' }[b.qualityGrade] || 'average') : 'average'),
          qualityScore: b.qualityScore ?? null,
          qualityGrade: b.qualityGrade,
          qualityReasons: Array.isArray(b.qualityReasons) ? b.qualityReasons : undefined,
          enrichmentOwner: String(b.enrichmentOwner || ''),
          enrichmentSource: String(b.enrichmentSource || ''),
          enrichmentConfidence: typeof b.enrichmentConfidence === 'number' ? b.enrichmentConfidence : 0,
          enrichmentMethod: String(b.enrichmentMethod || ''),
